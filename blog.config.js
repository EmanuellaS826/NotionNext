...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '我还能做到什么,我还能改变什么,我还能理解什么,我还能遗忘什么',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '发发', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个试图在互联网暗处寻求喘息的家伙', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '地址没想好呢', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '私人, 博客', // 网站关键词 英文逗号隔开
